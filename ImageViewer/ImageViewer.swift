...
extension ImageViewer {
	fileprivate func imageViewerItemViewController(withIndex index: Int) -> ImageViewerItemViewController {
		let itemViewController = UIStoryboard(name: "Main", bundle: Bundle(identifier: "caiomello.ImageViewer")).instantiateViewController(withIdentifier: "ImageViewerItem") as! ImageViewerItemViewController
